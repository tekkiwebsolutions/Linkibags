								...
								<form name="dash_form" method="post" id="share_urls_from_dash" action="index.php?p=dashboard&ajax=ajax_submit">
									...
									?>
										<div class="tab-content-box">
											<div style="margin-bottom: 6px;" class="user-name-dash">
												<div class="row">
													<div class="col-md-6">
														<a class="text-gray" onclick="multiple_load_share_link_form('share');" href="#"> 
														<i class="fa fa-share"></i> Share Selected Option <!--Links--></a>
													</div>
											...
											<div class="mail-dashboard">
														...
														<div class="modal-dialog modal-sm">
															<div class="modal-content">
																...
																<div class="modal-body">
																	...
																	<td style="width:28%; text-decoration: underline;"><?=((strlen($urlpost['url_desc']) > 30) ? substr($urlpost['url_desc'], 0, 30).'...' : $urlpost['url_desc'])?></td>
												...
												<table class="border_block table table-design sponsored-table">
													<tbody>
														...
														?>
															<tr>
																<td style="width:32%"><!--<span><input type="checkbox" name="check" value="" disabled></span>--> &nbsp; <a target="_blank" href="<?=$list_shared_links_by_admn['url_value']?>" style="color: #999999 !important;"><?=$list_shared_links_by_admn['url_value']?></a></td>
																<td style="width:20%; color: #999999 !important;">Admin</td>
																<td style="width:28%; color: #999999 !important;"><?=((isset($list_shared_links_by_admn['url_desc']) and $list_shared_links_by_admn['url_desc'] != '') ? substr($list_shared_links_by_admn['url_desc'] , 0, 20) : 'Sponsored')?>...</td>
																<td class="text-right" style="width:20%; color: #999999 !important;"><?=date('d/m/Y', $list_shared_links_by_admn['created_time'])?>   <?=date('h:ia', $list_shared_links_by_admn['created_time'])?>
																</td>
