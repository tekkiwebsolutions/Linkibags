...
function page_content(){
	global $co, $msg;
	$co->page_title = "Register as Education Account | LinkiBag";
?>
<section id="public-bag">
	<div class="container-fluid bread-crumb top-line">
		<div class="col-md-7">
			<p><a href="index.php">Home</a> > Education Account Signup</p>
		</div>
		<div class="col-md-4">
	...
	<div class="containt-area">	
		<div class="main-heading container">			
			<img src="images/Logo_Education_icon_HIGH RES.png" class="img-responsive linki-logo">
			<h1 class="page-title">Educational Account</h1>
			<p class="page-subtitle">
				Important : Your Educational institution must have an Educational LinkiBag account established prior to signing up.Your institutional <br/>  account number is required to use this form.<a href=""> Click here</a> to contact our team to open a LinkiBag account for your  educational institution.
			</p>
			<div class="form-title">
				<h2>Sign up for your Educational LinkiBag Account </h2>
			</div>			
		</div>
			<br>
		<div class="container">
			<div class="row">
				<form method="post" id="register_form" action="index.php?p=education-account&ajax=ajax_submit" onsubmit="javascript: return submit_register();">
				<div id="messagesout"></div>
				<input type="hidden" name="form_id" value="register"/>
				<input type="hidden" name="role" value="education"/>
					...
					<h5 class="form-title"><strong>Login Information</strong></h5>
						...
						<div class="form-group">
							...
							<input type="text" name="email_domain" class="form-control" value="<?=((isset($_POST['email_domain']) and $_POST['email_domain']!='') ? $_POST['email_domain'] : '')?>" />
								<span class="bootom-info-corporate-domain">Your school's domain</span>
							</div>						
						</div>
						<div class="form-group">
