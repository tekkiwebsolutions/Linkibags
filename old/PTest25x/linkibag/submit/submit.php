...
if($_SERVER['REQUEST_METHOD']=='POST'){
	...
	if(isset($_POST['form_id']) and $_POST['form_id']=="forget_password"){
		...
		{	
			...
			if($_POST['ajax'] == 1){
				echo json_encode(array('msg'=>"<div class='alert alert-success'>Thanks! you will receive a password reset instructions. If you don't receive an email, please check your spam folder.</div>"));
				exit();
			}
		...
		{
			if($_POST['ajax'] == 1){
				echo json_encode(array('msg'=>"<div class='alert alert-danger'>No account found with that email address. Please check email address below and try again. To create a new account, visit the Free Signup page.</div>"));
				exit();
			}
