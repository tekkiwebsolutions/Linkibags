					...
					if(res2.option){
						...
						if(rowCount === 11){
							if(res2.this_page === 'p=linkifriends'){
								...
								jQuery("#all_records tr").slice(-10).remove();		
	...
	$.ajax({
		...
		success: function(res2) {
			...
			if(res2 === 'true'){
				...
				$("#dialog_success").html("Thank you for an invite! We will check our records and will send your invite, if user haven't join yet LinkiBag!");
				$("#dialog_success" ).dialog( "open" );
				$(".ui-dialog-titlebar.ui-widget-header.ui-corner-all.ui-helper-clearfix").addClass( "dialog_success" );		
			}else{				
	...
	$.ajax({
		...
		success: function(res2) {
			...
			if(res2.success === true){
				...
				$("#dialog_success" ).dialog( "open" );
				$(".ui-dialog-titlebar.ui-widget-header.ui-corner-all.ui-helper-clearfix").addClass( "dialog_success" );
				$(".ui-dialog.ui-widget.ui-widget-content.ui-corner-all.ui-front.ui-dialog-buttons.ui-draggable.ui-resizable").addClass( "sharing-links-success-panel-widget" );				
