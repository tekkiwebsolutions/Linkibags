  ...
  <div class="carousel-inner">
     <div class="item slides active">
      ...
      <div style="transform: none; left: 0px; right: 0px; top: 30px; text-shadow: none ! important;" class="hero container">
         <div class="col-md-6">
		<hgroup>
			<h1>ALWAYS FREE * <a class="btn btn-hero btn-lg" href="index.php?p=personal-account"role="button" style="margin: 0px 0px 5px; float: right; text-transform: none; font-weight: 600;">Free Signup ></a> </h1>
	...
	<div style="background: rgb(57, 117, 83) none repeat scroll 0% 0%;" class="item slides ">
      ...
      <div style="text-shadow: none; transform: none; right: 0px; top: 70px; left: 60px;" class="hero container">
		...
		<hgroup>
			...
			<a style="font-weight: 600;" class="btn btn-hero btn-lg" role="button" href="index.php?p=education-account">Read More ></a>
        </hgroup>
		</div>
      </div>
    </div>
...
<a style="font-weight: 600; margin-top: 48px;" class="btn btn-hero btn-lg" role="button" href="index.php?p=business-account">Read More</a>
</hgroup>
		</div>
      </div>
    </div>
			...
			<div class="container text-center top-margin">
				<div class="row">
					<div class="col-md-12 text-left wow fadeInUp templatemo-box web-links-title-bag" data-wow-delay="0.3s">
						<div class="section-title-blue"><h2>Now Trending: Business Category</h2></div>
					...
					if(isset($trending_cats['cid']) and $trending_cats['cid'] > 0){
						...
						echo '<div class="link-list-trending"><img src="images/trending-hand.jpg" class="img-responsive" alt="home img"><h1><a href="#" target="_blank">'.$trending_cats['cname'].'</a></h1>
						<h4>Select the option ‘add to public bag’ to send your link to be included here.</h4></div>';						
							
					}else{
						echo '<div class="link-list-trending"><img src="images/trending-hand.jpg" class="img-responsive" alt="home img"><h1>Share with the World</h1>
							<h4>Select the option ‘add to public bag’ to send your link to be included here.</h4></div>';							
					}	
				...
				<div class="row">
					<div class="video-section">
						...
						<div class="col-md-5" data-wow-delay="0.3s">
							<div class="section-title-blue"><h2>Video Pick of the Week <i class="fa fa-caret-right"></i></h2></div>
							<?php
						...
						<div class="col-md-6 pull-right" data-wow-delay="0.3s">
							...
							<h2>Link Pick of the Week 
								<a class="fa fa-caret-right" data-slide="next" href="#media" style="text-decoration: none;"></a>
								<a class="fa fa-caret-left" data-slide="prev" href="#media" style="text-decoration: none; margin: 0px 6px;"></a>
							</h2></div>
							<div class="row">
								<div class="share-link-icon col-md-1" style="padding-right: 0px;">
