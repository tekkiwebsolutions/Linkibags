...
$sql = "SELECT url.*, c.*,p.first_name,p.last_name from category c, user_urls url, profile p WHERE p.uid=url.uid and url.url_cat=c.cid and url.status='1'";
$cond_arr = array();
...
?>								<form class="form-horizontal" enctype="multipart/form-data" method="GET">									
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover table-striped">
										<thead>
											<tr>
												<th>Sr no.</th><th>Url Title</th><th>Name</th><th>Url Value</th><th>Url Description</th><th>Url Category</th><th>Public Bag Link</th><th>Pick Week Link</th><!--<th>Trending Link</th><th>Youtube Link</th>--><th>Created On</th><th>Actions</th>
											</tr>
										</thead>
									   <tbody>
