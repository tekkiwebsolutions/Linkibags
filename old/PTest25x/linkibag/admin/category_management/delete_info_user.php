...
if(isset($_POST['del_yes']) && $_POST['del_yes']=="yes"){
	if(isset($_GET['delid'])){
		...
		$co->query_delete('user_public_category', array('id'=>$_GET['delid']),'cid=:id');
...
if(isset($_GET['delid'])){	
	...
	$row = $co->query_first("SELECT * from user_public_category WHERE cid=:id",array('id'=>$_GET['delid']));
	if(isset($row['cid'])){
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-table"></i> Public Category info
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3 class="panel-title"><i class="fa fa-table"></i> Delete Public Category</h3>
							</div>
							<div class="panel-body">
								<h3> Are you sure you want to delete public category(<?=$row['cname']?>) - ID(<?=$row['cid']?>) ?</h3>
								<ul style="display: none;">
									<li>It will delete (<?php/*<?=$total_shared_cat['total_cat']?>*/?>) URLs shared by this public category.</li>
