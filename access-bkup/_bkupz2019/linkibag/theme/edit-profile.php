			...
			<div class="container">
					...
					<div class="row">
											...
											<div class="personal_account_register">
												<div class="fst">
													<div class="form-group">
														...
														<div style="padding-right: 7px;" class="col-md-4 form-size">
													...
													<div class="form-group">
														<div class="col-md-2 pad-sm"><label class="mylabel">Login</label></div>
														<div class="col-md-7">
						...
						<div style="margin-bottom: 0px;" class="form-group">
							...
							<div style="padding-right: 5px;" class="col-md-4 form-size">              
					...
					<div style="border-top: 6px solid #c3c3c3; border-bottom: 6px solid #c3c3c3; padding: 11px 0px 0px; margin: 18px 0px 17px;" class="fst">
						...
						<div class="form-group">
							<div class="col-md-2 pad-sm"><label class="mylabel">Security Question<span class="required-field">*</span></label></div>
							<div class="col-md-10">
						...
						<div class="form-group">
							<div class="col-md-2 pad-sm"><label class="mylabel">Answer<span class="required-field">*</span></label></div>
							<div class="col-md-7">								
					...
					<div class="fst">
						...
						<div class="form-group">
							<div class="col-md-2 pad-sm"><label class="mylabel">Subscribe<span class="required-field">*</span></label></div>
							<div class="col-md-7">		
