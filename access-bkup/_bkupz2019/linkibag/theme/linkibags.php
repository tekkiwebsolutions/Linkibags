										...
										<div class="tab-content-box">
											<div class="row top-folder-header">
												<div class="col-md-12 text-right folder-header-right">
													...
													<a class="btn button-grey" href="#" href="#" onclick="load_add_frm('category','0')">Add New Folder</a>
												</div>
											</div>
											...
											<div class="mail-dashboard folder-dash-data">
												<table class="border_block table table-design" id="all_records">
													...
													?>
														<tr class="first_row text-bold" id="record_0">
														...
														<tr class="second_row text-bold" id="record_1">
															...
															<td style="width:10%"><a class="btn btn-sm" href="#" onclick="<?=$empty_links?>">Empty</a></td>
