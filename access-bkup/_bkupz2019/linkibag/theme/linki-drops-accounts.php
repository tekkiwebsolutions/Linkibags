  ...
  <div class="container main-container">
    <div class="row">
      <div class="col-md-4 text-left wow fadeInUp templatemo-box" data-wow-delay="0.3s">
        ...
        <div class="image-blow-text">Signup for your risk free <span class="orange-color">FREE</span> <span class="orange-blue"><a class="orange-blue" href="index.php?#free_singup">Personal Account</a></span> today.</div>
        <?php } ?>
      </div>
      <div class="col-md-8 about-block page-new" data-wow-delay="0.3s">
        <div class="row">
          ...
          <div class="col-md-7">
            <ul class="sub-page-listing-links">
              ...
              <li class="active"><a href="index.php?p=linki-drops-accounts">LinkiDrops Accounts </a></li>
            </ul>
          </div>
        </div>
        <div class="page-btns">  
		...
		<a class="com-link faq_link" href="index.php?p=contact-us">Leave us a message</a>	
