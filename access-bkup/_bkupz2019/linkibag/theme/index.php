  ...
  <div class="carousel-inner">
     <div class="item slides active">
      ...
      <div style="transform: none; left: 0px; right: 0px; top: 30px; text-shadow: none ! important;" class="hero container">
         <div class="col-md-6">
		<hgroup>
			<h1>ALWAYS FREE * <a class="orange-btn" href="index.php?p=free-personal-accounts"role="button" style="margin: 0px 0px 5px; float: right; text-transform: none; font-weight: 600;">Free Sign up ></a> </h1>
	...
	<div style="background: rgb(57, 117, 83) none repeat scroll 0% 0%;" class="item slides ">
      ...
      <div style="text-shadow: none; transform: none; right: 0px; top: 70px; left: 60px;" class="hero container">
		...
		<hgroup>
			...
			<a style="font-weight: 600;" class="orange-btn" role="button" href="index.php?p=institutional-accounts">Read More ></a>
        </hgroup>
		</div>
      </div>
    </div>
...
<a style="font-weight: 600; margin-top: 48px;" class="orange-btn" role="button" href="index.php?p=business-accounts">Read More ></a>
</hgroup>
		</div>
      </div>
    </div>
                     ...
                     <div class="personal_account_register">
						...
						<div class="row">
							<div class="form-group">
								<div class="col-md-12">
									<h2 style="color: rgb(255, 255, 255); margin: 4px 0px 0px;">Sign up for your FREE account</h2>
									<p style="color: rgb(255, 255, 255);">Business and Institutional account upgrades will be available upon completion of your registration.</p>
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="form-group">
								<div class="col-md-6">
									<div class="form-group">
									<div class="col-md-5 pad-sm"><label class="mylabel">Login: <span class="required-field"> *</span></label></div>
									<div class="col-md-7">
									...
									<div class="form-group">
									<div class="col-md-5 pad-sm"><label class="mylabel">Password: <span class="required-field">*</span></label></div>
									<div class="col-md-7">
										<div class="">
									...
									<div class="form-group">
										<div class="col-md-5 pad-sm"></div>
										<div class="col-md-7">
											<div style="margin-top: 5px;" class="checkbox linki-chckboxbox ">
									...
									/*
									<div class="form-group">
										<div class="col-md-5 pad-sm"><label class="mylabel">Your Name: <span class="required-field">*</span></label></div>
										<div class="col-md-7"><input placeholder="Your Name" type="text" name="first_name" class="form-control" value="<?=((isset($_POST['first_name']) and $_POST['first_name']!='') ? $_POST['first_name'] : '')?>" /></div>
									</div>

									<div class="form-group">
									<div class="col-md-5 pad-sm"><label class="mylabel">Country: <span class="required-field">*</span></label></div>
									<div class="col-md-7">
										...
										<label style="margin-top: 10px;" class="mylabel required-fields"><span class="required-field">*</span> Required Fields</label>
									</div>
									</div>

									<div class="form-group">
									<div class="col-md-5 pad-sm"><label class="mylabel">Confirm Password: <span class="required-field">*</span></label></div>
									<div class="col-md-7">
								   ...
								   <select class="form-control linkibox_select" name="salutation" >
									...
									<div class="col-md-7"><input placeholder="First Name" type="text" name="first_name" class="form-control" value="<?=((isset($_POST['first_name']) and $_POST['first_name']!='') ? $_POST['first_name'] : '')?>" /></div>
									</div>

									<div class="form-group">
									<div class="col-md-5 pad-sm"><label class="mylabel">Last Name: <span class="required-field">*</span></label></div>
									<div class="col-md-7"><input placeholder="Last Name" type="text" name="last_name" class="form-control" value="<?=((isset($_POST['last_name']) and $_POST['last_name']!='') ? $_POST['last_name'] : '')?>" /></div>
									</div>
									*/ ?>
									...
									<div class="form-group">
											<div class="col-md-5 pad-sm">
												...
												<div class="col-md-7">
													<!--<span class="required-field pull-right captcha_req">*</span>-->
									...
									<div style="margin: 0px;" class="form-group">
										...
										<div style="margin-top: 0px;" class="checkbox linki-chckboxbox ">
											...
											<label for="checkbox3">
												Sign me up for email flyers with LinkiBag promotions and discounts.
											</label>
										</div>
								...
								<div class="col-md-6">
									...
									<div class="col-md-7"><input placeholder="Company or Institution Name" type="text" name="account" class="form-control" value="" /></div>
									</div> -->
