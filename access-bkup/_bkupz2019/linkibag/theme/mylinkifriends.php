										...
										<div class="tab-content-box">
										  <ul class="head-design table-design folder-dash-filters">
											...
											?>
												...
												<li style="width:15%">
													<div class="dropdown dropdown-design">
													<div style="padding-left:0px;" class="btn btn-default dropdown-toggle text-center">Confirmed <a href="index.php?p=mylinkifriends&order_by[group_id]=<?=$url_by?>"><i class="<?=((isset($_GET['order_by']) and array_key_exists("group_id",$_GET['order_by']) and in_array('asc', $_GET['order_by'])) ? 'fa fa-caret-up' : 'fa fa-caret-down')?>"></i></a></div>
													</div>	
												</li>
												<li style="width:15%">
													<div class="dropdown dropdown-design">
													<div class="btn btn-default dropdown-toggle text-center">Total <a href="index.php?p=mylinkifriends&order_by[created]=<?=$url_by?>"><i class="<?=((isset($_GET['order_by']) and array_key_exists("created",$_GET['order_by']) and in_array('asc', $_GET['order_by'])) ? 'fa fa-caret-up' : 'fa fa-caret-down')?>"></i></a></div>
													</div>	
												</li>
											</ul>
