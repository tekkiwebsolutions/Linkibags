								...
								<form name="dash_form" method="post" id="share_urls_from_dash" action="index.php?p=dashboard&ajax=ajax_submit">
									...
									<div class="tab-content-box">
										...
										<div style="margin-top: 12px; margin-bottom: 3px;" class="user-name-dash">
											<div class="row">
															<div class="col-md-4">	
																<h4 class="text-green user-name-dash"><i class="fa fa-users"></i> Linki Friends <span class="badge round-red-badge" id="new_linkibag_friends"><?=$total_friends?></span></h4>
															</div>
															<div class="col-md-8">
													...
													/*
																...
																*/
																?>
																<a class="btn button-grey pull-right" href="index.php?p=linkifriends">My Groups</a>	
																</div>
																<div class="col-md-3 linki-friends-search-top">
												...
												<div class="mail-dashboard">
													...
													<table class="border_block table table-design margin-none">
														<tbody>
															<?php               
															$i=1;                                
															if(isset($_GET['page'])){         
										...
										<div class="bottom-nav-link table-design margin-none">                
											<div class="bottom-nav-link-main">
												...
												<div class="col-md-5 text-right">  										
													<a onclick="move_to_category_multiple('#share_urls_from_dash','group','2', '1');" class="btn btn-default dark-gray-bg" href="#">Unread</a>
