    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">You are about to visit the alpha version of LinkiBag Portal</h4>
        </div>
        <p class="model-block">The alpha phase of the release life cycle is the first phase of website testing. This is an initial development version that was released to help improve portal and fix bugs that may still be present in the website. It is expected that the alpha version of the website will be incomplete and may be buggy. The product or service may undergo extended changes or updates before the next version is released. Use of the alpha version may provide the company with feedback from test users. This version may not contain all features that are planned for the final version and may have a feature freeze for blocks that will be added to the website later.<br><br>

		By clicking "I Accept," you confirm that you are at least 18 years of age, have read the terms and conditions of the portal use, and have read the terms of use for the alpha version of this website. You confirm that you understand them and that you agree to be bound by them (you accept them). By clicking "I Accept," you also confirm that you will be using the alpha version of LinkiBag Portal and we are not responsible for entries that are lost, late, misaddressed or misdirected due to technical or any non-technical failures; errors or data loss of any kind; lost or unavailable internet connections; failed or incomplete, garbled or deleted computer or network transmissions; an inability to access the website or online service; or any other technical error or malfunction.<br><br>

		Use of this website is subject the Terms and Conditions for using the alpha version of the website and subject to the Website Terms and Conditions. These Terms and Conditions constitute a legally binding agreement between you the company regarding the use of the service.If you do not agree with any of the terms of these Terms and Conditions, click the "Exit" button next to the text that reads "I am over 18 years old and I have read, printed, and accepted the Terms and Conditions." Do not click the "I Accept" button and do not attempt to use or continue using any of the services.</p>
		<div class="modal-footer ">
			<div class="pull-left">
				 <button id="accept" type="button" class="btn btn-info btn-md" >I Accept</button>
				 <button type="button" id="exit_btn" class="btn btn-danger">Exit</button>
			</div>
	    </div>
      </div>
