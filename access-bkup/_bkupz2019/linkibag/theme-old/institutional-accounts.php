	...
	<section id="public-bag">
				...
				<div class="container main-container">
					...
					<div class="row">
						...
						<div class="col-md-8 about-block page-new" data-wow-delay="0.3s">														<div class="row">							<div class="col-md-5">							<h2 class="page-title-account"><?=$page['title']?></h2>							<div class="sub-title-inner-heading"><span class="color-gray">> <a class="color-gray" href="index.php?p=contact-us">Contact us</a> </span><span class="orange-blue">for more information</span></div>							</div>							<div class="col-md-7">							<ul class="sub-page-listing-links">								<li><a href="index.php?p=free-personal-accounts">FREE Personal Accounts </a></li>								<li><a href="index.php?p=business-accounts">Business Accounts </a></li>								<li class="active"><a href="index.php?p=institutional-accounts">Institutional Accounts (discounted rates)</a></li>								<li><a href="index.php?p=linki-drops-accounts">LinkiDrops Accounts </a></li>							</ul>												</div>							</div>								<div class="page-btns">							</div>														
							<?=$page['page_body']?>							
						</div>
