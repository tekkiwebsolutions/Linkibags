	<?php
		...
		$co->page_title = "Business Accounts | LinkiBag";
		$page = $co->query_first("SELECT * FROM pages WHERE page_id=:id ", array('id'=>2));
...
<?php
$img = $co->query_first("SELECT * FROM page_imgs WHERE entity_id=:id ORDER BY RAND()", array('id'=>2));
echo '<img class="margin-bottom" src="' . $img['img_original'] . '" border="0" />';

?>						

							<div class="image-blow-text">
							Try us risk free. Start with a <span class="orange-color">FREE</span> <span class="orange-blue"><a class="orange-blue" href="index.php?p=personal-account">Personal Account</a></span> today.
							</div>
						</div>
						<div class="col-md-8 about-block page-new" data-wow-delay="0.3s">
							<div class="row">
								<div class="col-md-5">
									...
									<span class="color-gray">> <a class="color-gray" href="index.php?p=contact-us">Contact us</a> </span><span class="orange-blue">for more information</span>
									</div>
								</div>
								<div class="col-md-7">
									<ul class="sub-page-listing-links">
										<li><a href="index.php?p=free-personal-accounts">FREE Personal Accounts </a></li>
										<li class="active"><a href="index.php?p=business-accounts">Business Accounts </a></li>
