  ...
  <div class="container main-container">
    <div class="row">
      <div class="col-md-4 text-left wow fadeInUp templatemo-box" data-wow-delay="0.3s">
        ...
        <div class="image-blow-text">Signup for your risk free <span class="orange-color">FREE</span> <span class="orange-blue"><a class="orange-blue" href="index.php?p=personal-account">Personal Account</a></span> today.</div>
      </div>
