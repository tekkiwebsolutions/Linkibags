		...
		*/  	  	
		...
		<section class="dashboard-page"> 
			<div class="container bread-crumb top-line">    
				<div class="col-md-7">      
					<p><a href="index.php">Home</a><a href="index.php?p=dashboard"> > Inbox</a></p>    
				</div> 
											...
											<div class="mail-dashboard">
												...
												<table class="border_block table table-design sponsored-table">
													<tbody>
														...
														?>
															<tr style="position: relative;" class="alert">
																...
																<td style="width:15%"><?=date('d/m/Y', $list_shared_links_by_admn['created_time'])?>   <?=date('h:i:sa', $list_shared_links_by_admn['created_time'])?>
																
																<a href="#" style="position: absolute; top: -1px; right: 1px;" type="button" data-dismiss="alert"><img src="images/cancel.jpg"></a>
																</td>
															</tr>
															<?php
															}
