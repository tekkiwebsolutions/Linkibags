				...
				<div class="login-form"> 
					<form autocomplete="off" id="login_form" action="index.php?ajax=ajax_submit" onsubmit="javascript: return ajax_login();" method="post" role="form">	
						...
						<div class="form-group text-right">           
							<input tabindex="1" type="email" placeholder="Email Address" class="form-control form-control-clean" id="email" name="email_id">
							<a href="index.php?p=personal-account">Free Signup</a>              
						</div>                  
