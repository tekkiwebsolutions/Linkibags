...
function page_content(){      
	...
	if(isset($_GET['id']) and $_GET['id']!=''){      		
		...
		$row = $co->query_first("SELECT ur.url_id,ur.url_title,ur.url_value,ur.url_desc,u.email_id,us.shared_url_id,us.shared_time,us.shared_to,us.url_cat FROM user_urls ur, users u, user_shared_urls us WHERE us.uid=u.uid and ur.url_id=us.url_id and us.shared_to=:uid and us.shared_url_id=:id ORDER BY us.shared_url_id DESC", array('uid'=>$current['uid'], 'id'=>$_GET['id']));
					...
					<div class="containt-area-dash col-md-9">      
						<div class="view-link-page">
							<div class="user-name-dash">
								<span class="text-blue" href="index.php?p=add_url">Link Details</span>
							</div>
							<div class="gray-box">
