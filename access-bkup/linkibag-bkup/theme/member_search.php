...
function page_content(){      
	...
	$total_friends_url = $co->users_count_shared_url($current['uid']);      
		...
		<section class="dashboard-page">  
			...
			<div class="col-md-12">      
				<p><a href="index.php">Home</a> &gt; Connect
				<span class="pull-right" style="color: #257829; font-size: 14px;margin-right: 13px;">Primary Member Services</span>	
				</p>
			</div> 
			</div>
										...
										<div class="tab-content-box">
											<div class="search-user">    
												<div class="input-group">
													...
													<h4 class="text-blue">Member Search</h4>
													</div>
												</div>
											...
											*/
											...
											<div class="mail-dashboard folder-dash-data" id="search_friends">
												<div style="border: 2px solid #257829" id="all_records" class="search_friends_main">
													<h3 class="light-green-color"><i class="fa fa-search fa-fw" aria-hidden="true"></i> Member Search</h3>
													<form class="sign_up_page_form" method="post" id="connect_form" action="index.php?p=personal-account&ajax=ajax_submit" onsubmit="javascript: return send_friend_request(this, 'yes');">
																 ...
																 <div class="personal_account_register">
																	<div class="form-group">
																		...
																		<div class="col-md-4">            
																			...
																			<button type="submit" class="orange-btn blue-bg" id="invite_in_db" style="display: none;">Invite</button>
																		</div>
																	</div>
