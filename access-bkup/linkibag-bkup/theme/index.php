...
<script type="text/javascript">
<?php
if(isset($_GET['free_singup'])) {
	echo "
$(window).load(function(){	
	$('html, body').animate({
        scrollTop: $('#free_singup').offset().top
    }, 2000);
});
	";
}
                  ...
                  <div class="homepage-login-form">
                     <div>
						...
						<div class="row" style="margin-bottom: 10px;">
							...
							<div class="col-md-8">
							<input placeholder="you@mail.com" type="email" name="email_id" aria-describedby="basic-addon1" id="signup_email_id" class="form-control" value="<?=$post_email_id?>" <?=$post_email_readonly?> />
							</div>
						</div>
