         ...
         <div class="containt-area-dash col-md-9">
            <div class="row">
			   ...
			   <div class="grouplinks">
				  <p><a href="?p=mylinkifriends">My Groups</a></p>
				  <p><a data-toggle="modal" data-target="#addmultipleusers">Upload List of Emails</a></p>
			   </div>
               ...
               <a class="btn button-grey" style="padding:4px 12px; width: 100%" href="javascript: void(0)" >Select Group</a>
               </div>
