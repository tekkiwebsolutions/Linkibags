			...
			<div class="col-md-4 col-md-offset-3 login-page-right">
				<div class="login-form"> 
					<form id="login_form" action="" method="post" class="login_frm">
						...
						<span class="forgot-note">Your password must contain at least 9 characters, include both lower and uppercase characters and at least one number or symbol.<!--Enter the email you used in your LinkiBag profile. A password reset link will be sent to you by email.--></span>
						
						<div class="form-group text-right">           
							<input tabindex="1" class="form-control form-control-clean" type="text" required="required" value="<?=(isset($_POST['user_email']) ? $_POST['user_email'] : '')?>" placeholder="Profile Email Address *" name="user_email"/>          
						</div>
