...
$title = '<i class="fa fa-table"></i> Edit Folder Information';
if(isset($_POST['save'])){	
	...
	if ($success == true) {
		...
		echo '<script type="text/javascript">window.location.href="main.php?p=folder/manage"</script>';
		exit();
	}
}
			...
			<form class="form-horizontal" method="post" enctype="multipart/form-data">
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						...
						<input type="radio" name="trending_cat" value="0" <?php if ((isset($row['trending_cat']) and $row['trending_cat'] == 0) OR (!isset($row['trending_cat']))) { echo 'checked';} ?> /> No
					</div>				
				</div>
				<div class="form-group">
