...
//			$sql .= " ORDER BY us.sponsored_link ASC, us.shared_to DESC";
    ...
    function share_linkibook($shared_with, $shared_by, $shared_to, $books, $share_id, $share_number) {
		...
		$verified_link = WEB_ROOT.'/index.php?p=view-share-linkibook&share_id='.$share_id.'&share_to='.urlencode($shared_to).'&share_no='.$share_number;
		$message = 'Dear,<br /><br /><p>'.$shared_by['first_name'].' '.$shared_by['last_name'].' shared linkibook with you.<br /><br/></p> <a style="border:none; padding: 5px; background: green; color:#fff; text-decoration: none;" href="'.$verified_link.'">View Page</a><br /><br />Cheers<br />Team Linkibag';				
		$from = 'info@linkibag.com';				
