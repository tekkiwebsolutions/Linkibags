...
$title = '<i class="fa fa-table"></i> List Subscribers';
$item_per_page = 12;


$sql = "SELECT u.*, p.* from profile p, users u WHERE u.uid=p.uid and p.subscribe=1";
...
$this_page = "p=user_management/subscribers";				
...
?><script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-table/1.17.1/extensions/export/bootstrap-table-export.js"></script>
