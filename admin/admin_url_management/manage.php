...
$sql = "SELECT * from user_urls url LEFT JOIN category c ON c.cid=url.url_cat WHERE url.uid=:id and url.status='1' ORDER BY url_id DESC";
...
?>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover table-striped">
										<thead>
											<tr>
												<th>Sr no.</th><th>Url Title</th><th>Url Value</th><th>Url Description</th><th>Url Category</th><th>Pick Week Link</th><th>Created On</th><th>Actions</th>
											</tr>
										</thead>
									   <tbody>
