...
$sql = "SELECT url.*, c.*,p.first_name,p.last_name,us.like_status,us.recommend_link from category c, user_urls url, profile p, `user_shared_urls` us WHERE us.url_id=url.url_id and url.uid=us.shared_to and p.uid=url.uid and url.url_cat=c.cid and url.status='1'";
$cond_arr = array();
...
?>								<form class="form-horizontal" enctype="multipart/form-data" method="GET">									
									...
									<div class="form-group">										
										...
										<div class="col-sm-3">											
											<select name="status_type" class="form-control">
												...
												<?php
												$status_typ = array('Liked','Unliked','Recommended','Unrecommended');
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover table-striped">
										<thead>
											<tr>
												<th>Sr no.</th><th>Url Title</th><th>Name</th><th>Url Value</th><th>Url Description</th><th>Url Category</th><th>Public Bag Link</th><th>Pick Week Link</th><th>Liked-Link</th><th>Recommended Link</th><!--<th>Trending Link</th><th>Youtube Link</th>--><th>Created On</th><th>Actions</th>
											</tr>
										</thead>
									   <tbody>
											...
											$links = array('No','Yes');	
											$links_type = array('Pending','Yes','No');	
											foreach($rows as $row){
											...
											<tr>
												...
												<td><?=$links[$row['pick_week_link']]?></td>
												<td><?=$links_type[$row['like_status']]?></td>
												<td><?=$links_type[$row['recommend_link']]?></td>
												<?php
												/*<td><?=$links[$row['trending_link']]?></td>
