<?php  
   ...
   function page_content(){      
      ...
      $urlposts_retrun = $co->get_mylinks_urlposts($current['uid'],$item_per_page, $this_page, $cid, $searchurl, $searchinclude);        
   ...
   <div class="containt-area " id="dashboard_new">
      <div class="container">
         ...
         <div class="tab-content">
            <form name="dash_form" method="post" id="share_urls_from_dash" action="index.php?p=mylinks&ajax=ajax_submit">
						...
						<tr>
							<td class="width32">
								...
								<div class="dropdown dropdown-design">
								   <div class="btn btn-default dropdown-toggle"><input type="checkbox" name="check" id="checkAll" value=""/>Links <a href="index.php?p=mylinks<?=$url_by?>"><i class="<?=$arrow_direction?>"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
								</div>
							</td>
							<td class="width28">
								<?php
								   ...
								   ?>
								<div class="dropdown dropdown-design">
								   <div class="btn btn-default dropdown-toggle">Notes <a href="index.php?p=mylinks<?=$shared_by?>"><i class="<?=$arrow_direction?>"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
								</div>
							</td>
							<td class="width25">
								<?php
								...
								?>
								<div class="dropdown dropdown-design">
								   <div class="btn btn-default dropdown-toggle">Found by <a href="index.php?p=mylinks<?=$shared_by?>"><i class="<?=$arrow_direction?>"></i></a>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
								</div>
							</td>
							<td class="width15"> 
								<?php
								...
								?>
								<div class="dropdown dropdown-design">
								   <div class="btn btn-default dropdown-toggle">Date Added <a href="index.php?p=mylinks<?=$date_by?>"><i class="<?=$arrow_direction?>"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
								</div>
							</td>
						</tr>
						</tbody>
					   ...
					   $total_page_count = 1;
						...
						if($total_page_count >0){	
							...
							if(isset($_GET['page'])){
								if($_GET['page'] > 1 ){
									$p_link = $_GET['page'] - 1;
									$prev_link = 'index.php?page='.$p_link.'&p=mylinks';
								}else{
									$prev_link = 'index.php?p=mylinks';
								}
							}
							if(isset($_GET['page']) and $_GET['page'] > 1){
								...
								if($total_page_count > $_GET['page']){
									...
									$n_link = $_GET['page'] + 1;
									$next_link = 'index.php?page='.$n_link.'&p=mylinks';
								
								}else{
									$next_link = 'index.php?page='.$_GET['page'].'&p=mylinks';
								}
							}else{
								 $next_link = 'index.php?page=2&p=mylinks';
							}
						}	  
			    ?>
				<div class="row">
                     ...
                     <div  style="padding: 0px;" class="col-md-7">
                        ...
                        <div class="dropdown border-bg-btn" style="display: inline;">
                           <select style="text-align: left;" name="filter" class="btn btn-default dropdown-toggle filter"  onchange="fiter_with_folder_dashboard(this.value)">
                              <option value="-2">My Links</option>
                              <option value="0"<?=($cid==0) ? ' selected="selected"' : ''?>>Trash</option>
                              <?php
                                 foreach($show_all_category_of_current_user as $list){
                                    $sel = '';
                        ...
                        &nbsp;
                        <a class="btn button-grey" href="javascript: void(0);" onclick="multiple_load_share_link_form('share');"><i class="fa fa-share-alt" aria-hidden="true"></i> Share</a>
                        &nbsp;
