                        ...
                        <div class="row">
                           ...
                           <div class="col-md-8">
                              <div class="row text-right">
                                 <div class="col-md-2 text-left paddingr">
                                    <?php
                                       /*
                                    ...
                                    if(isset($_GET['fstatus']) and $_GET['fstatus'] == '0'){ ?>
                                       <td class="message">
                                          <?php if(strlen($list['description']) > 80){ ?>
                                            <div class="line-width "> <a href="javascript: void(0);" data-toggle="tooltip" title="<?=$list['description']?>"><?=substr($list['description'], 0, 80)?>..</a></div>
                                          <?php }else{ ?>
                                             <?=$list['description']?>
                                       </td>
                                     <?php 
