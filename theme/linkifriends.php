<?php  
   ...
   function page_content(){      
   	...
   	$lists_of_all_friend = $co->list_all_friends_of_current_user($current['uid'], $fstatus, $item_per_page, $this_page,$fgroup, $searchkey);
            ...
            <div class="tab-content">
               <form name="dash_form" method="post" id="share_urls_from_dash" action="index.php?p=dashboard&ajax=ajax_submit">
                  ...
                  <div class="tab-content-box">
                    ...
                    <div style="margin-bottom: 11px;" class="user-name-dash linkifriends_block">
                        <div class="row">
							<div class="col-md-6 col-xs-12 linkifriends_b">
							   <?php
								  if(isset($_GET['gid'])){
								  ...
								  <a class="invites btn button-grey pull-right" href="index.php?p=search_friends"><i class="fa fa-chain"></i> Invites</a>										

							   <!--<a style="margin: 0px 10px;" class="btn button-grey pull-right" href="index.php?p=linkibags">My Folders</a>
					 ...
					 <div class="table margin-none table-responsive">
					   <?php 
                        $url_by = 'asc';
                           ...
                           <tbody>
                              <?php
                                 ...
                                 foreach($lists_of_all_friends as $list){
                                    ...
                                    */ ?>
                                    <?php if(isset($_GET['fstatus']) and $_GET['fstatus'] == '0'){ ?>
                                    <td class="datetime"><span><input type="checkbox" class="urls_shared" name="share_url[]" value="<?=$list['friend_id']?>"></span> &nbsp;
                                    ...
                                    <td class="group" style="<?=((isset($_GET['fstatus']) and $_GET['fstatus'] == '0') ? ' display: none;' : '')?>"><a href="javascript: void(0);"><?=(implode(", ", $group_names));?></a></td>
                                    <?php /*
                                       <td style="width:20%">
                                       	<?php
                                          if($list['request_to']>0){
                                    ...
                                    */ ?>
                                    ...
                                    if(isset($_GET['fstatus']) and $_GET['fstatus'] == '0'){ ?>
                                       <td class="message">
                                          <?php if(strlen($list['description']) > 80){ ?>
                                            <div class="line-width" style="overflow: hidden;white-space: nowrap; text-overflow: ellipsis;"> <a href="javascript: void(0);" data-toggle="tooltip" title="<?=$list['description']?>"><?=substr($list['description'], 0, 80)?>..</a></div>
                                          <?php }else{ ?>
                                             <?=$list['description']?>
                                       </td>
                                     <?php 
                                    ...
                                    <?php if(!isset($_GET['fstatus'])){ ?>
                                    <td class="friends_since"><?=date('m/d/Y', $list['date_time_created'])?>   <?=date('h:i a', $list['date_time_created'])?>
                                    </td>
                                    <?php } ?>
                                 </tr>
                              <?php		
                           ...
                           $total_page_count = 1;
							...
							if($total_page_count >0){	
								...
								if(isset($_GET['page'])){
									if($_GET['page'] > 1 ){
										$p_link = $_GET['page'] - 1;
										$prev_link = 'index.php?page='.$p_link.'&p=linkifriends';
										if(isset($_GET['fstatus'])){
											$prev_link .= '&fstatus=0';
										}
									}else{
										$prev_link = 'index.php?p=linkifriends';
										if(isset($_GET['fstatus'])){
											$prev_link .= '&fstatus=0';
										}
									}
								...
								if(isset($_GET['page']) and $_GET['page'] > 1){
									...
									if($total_page_count > $_GET['page']){
										...
										$n_link = $_GET['page'] + 1;
										$next_link = 'index.php?page='.$n_link.'&p=linkifriends';
										if(isset($_GET['fstatus'])){
											$next_link .= '&fstatus=0';
										}
									}else{
										$next_link = 'index.php?page='.$_GET['page'].'&p=linkifriends';
										if(isset($_GET['fstatus'])){
											$next_link .= '&fstatus=0';
										}
									}
								}else{
									$next_link = 'index.php?page=2&p=linkifriends';
									if(isset($_GET['fstatus'])){
										$next_link .= '&fstatus=0';
									}
								}
                  ...
                  <div class="bottom-nav-link table-design margin-none">
                     <div class="bottom-nav-link-main">
                        ...
                        <div class="col-md-4">  										
                           ...
                           <a class="btn btn-default dark-gray-bg" onclick="delete_pending_request('#share_urls_from_dash','group', '0','0','-1');" href="javascript: void(0);">Delete</a>
                           <?php } ?>
