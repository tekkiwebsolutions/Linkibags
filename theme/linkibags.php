			...
			if((isset($_GET['order_by_custom']))){
				...
				$tbody .= '	
					<tr class="'.$class_name.'" id="record_'.$category['cid'].'">
						<td style="width:62%"><span><input type="checkbox" class="grouping" value="'.$category['cid'].'" name="categories[]"></span> &nbsp; <a href="index.php?p=mylinks&cid='.$category['cid'].'">'.$category['cname'].'</a> <span>&nbsp; <a href="javascript: void(0);" onclick="load_edit_frm('.$category['cid'].', \'category\')"><i class="fa fa-pencil"></i></a></span></td>
			...
			foreach($folders as $fol){
				...
				$tbody .= '	
					<tr class="'.$class_name.'" id="record_'.$fol['cid'].'">
						<td style="width:62%"><span><input type="checkbox" class="grouping" value="'.$fol['cid'].'" name="categories[]"></span> &nbsp; <a href="index.php?p=mylinks&cid='.$fol['cid'].'">'.$fol['cname'].'</a> <span>&nbsp; <a href="javascript: void(0);" onclick="load_edit_frm('.$fol['cid'].', \'category\')"><i class="fa fa-pencil"></i></a></span></td>
						<td style="width:10%"><a class="btn btn-sm" href="javascript: void(0);" onclick="'.$empty_link.'">Empty</a></td>
									...
									<input type="hidden" name="this_page" value="<?=$this_page?>"/>
										...
										<div class="tab-content-box">
											...
											<table class="table head_border_block">
												<tbody>
												<tr>
													<td class="selact_all" style="width:80%">
														<div class="dropdown dropdown-design">
															<div class="btn btn-default dropdown-toggle">
																<input type="checkbox" value="" id="checkAll" name="check"> Select All 
															</div>
														</div>	
													</td>
													<td>&nbsp;</td>
													<td class="total" style="width:20%">
														<div class="dropdown dropdown-design">
															<div class="btn btn-default dropdown-toggle text-center">Total 
																<a href="index.php?p=linkibags&order_by_custom[folder_total]=<?=$folder_by.$get_page_by?>">
																	<i class="<?=((isset($_GET['order_by_custom']) and array_key_exists("folder_total",$_GET['order_by_custom']) and in_array('asc', $_GET['order_by_custom'])) ? 'fa fa-caret-up' : 'fa fa-caret-down')?>"></i>
																</a>
															</div>
														</div>
													</td>
												...
												<table class="border_block table table-design" id="all_records">
													...
													?>
														...
														<tr class="first_row text-bold" id="record_1">
															<td style="width:62%"><span><input type="checkbox" disabled value="-2" id="inbag" name="categories[]"></span> &nbsp; <a href="index.php?p=mylinks&cid=-2">Inbag</a> <span>&nbsp; </span></td>
														...
														*/ ?>
														...
														<tr class="second_row text-bold" id="record_0">
															<td style="width:62%"><span><input type="checkbox" disabled value="0" id="trash" name="categories[]"></span> &nbsp; <a href="index.php?p=mylinks&cid=0&trash=1">Trash</a> <span>&nbsp; </span></td>
															<td style="width:10%"><a class="btn btn-sm" href="javascript: void(0);" onclick="<?=$empty_link?>">Empty</a></td>
