			...
			<div class="col-md-4 col-md-offset-3 login-page-right">
				<div class="login-form"> 
					<form id="login_form" action="" method="post" class="login_frm">
						...
						<div class="form-group text-right">           
							<input tabindex="1" class="form-control form-control-clean" type="text" required="required" value="<?=(isset($_POST['new_user_email']) ? $_POST['new_user_email'] : '')?>" placeholder="Enter new email address" name="new_user_email"/>          
						</div>	
						<div class="form-group text-right">           
